  ...
  return (
    <div className="relative flex flex-col items-center">
      <svg viewBox="0 0 200 110" className="w-48">
        ...
        {/* Labels */}
        <text x="6" y="115" fontSize="10" fill="#6b7280">
          Neg
        </text>
        <text x="89" y="18" fontSize="10" fill="#6b7280">
          Neu
        </text>
        <text x="175" y="115" fontSize="10" fill="#6b7280">
          Pos
        </text>
      </svg>
...
function ManualAnalyzer({ brands }: { brands: Brand[] }) {
  ...
  return (
    <Card className="p-6">
      ...
      {result && (
        <div className="animate-in mt-6 space-y-4 border-t border-gray-800 pt-5">
          {result.sentiment && (
            <div>
              ...
              >
                <div className="mb-2 flex items-center gap-2">
                  ...
                  <span
                    className={cn(
                      'font-bold',
                      result.hallucination.has_hallucination ? 'text-red-300' : 'text-emerald-300',
                    )}
                  >
                    {result.hallucination.has_hallucination
            ...
            <div className="grid grid-cols-2 gap-4 lg:col-span-2">
              {[
                ...
                },
                {
                  ...
                  icon: AlertTriangle,
                  color: stats.hallucinationRate > 0.1 ? 'text-red-400' : 'text-emerald-400',
                },
              ].map((s) => (
